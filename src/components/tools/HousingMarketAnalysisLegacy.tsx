      ...
      <div className="rounded-lg border border-gray-200 bg-white shadow-lg">
        ...
        <div className="overflow-x-auto">
          <div className="max-h-96 overflow-y-auto">
            <table className="min-w-full border-collapse text-xs"><thead className="sticky top-0 z-10 bg-gray-100"><tr>
                  {[
                    "Year",
                    "House Price",
                    "House Δ%",
                ...
                {chartData.map((row) => (
                  <tr key={row.year} className="hover:bg-gray-50"><td className="whitespace-nowrap px-3 py-2 font-medium text-gray-900">
                      {row.year}
                    </td><td className="whitespace-nowrap px-3 py-2 text-gray-700">
                    ...
                    </td><td className="whitespace-nowrap px-3 py-2 text-red-600">
